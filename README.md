...
Project Overview
This project focuses on analyzing customer churn using an interactive dashboard built in Power BI. The dashboard helps in understanding customer behavior, revenue contribution, service usage, and factors affecting churn. It allows businesses to monitor key metrics and identify patterns that impact customer retention.
Key Insights
